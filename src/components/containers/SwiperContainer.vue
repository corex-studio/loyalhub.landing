<template>
  <div>
    <div
      v-if="!noNavigation"
      class="row full-width justify-between px-lg-20 px-md-15 px-sm-0"
      style="position: absolute; left: 0; top: 50%; z-index: 2"
    >
      <CIcon
        @click="prevPage()"
...
import CIcon from '../templates/buttons/CIcon.vue';
