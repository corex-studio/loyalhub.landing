...
const blocks = [
  ...
  },
  {
    ...
    text: 'В вашем распоряжении окажется полный арсенал инструментов для увеличения возвращаемости гостей: внедрите бонусную программу, поздравляйте гостей с праздниками, сообщайте о новинках в меню и скидках на интересные предложения через ваши собственные каналы работы с горячей аудиторией. Влияйте на их решение о повторной покупке самостоятельно!'
  },
  {
    number: '08',
    title: 'CRM-систему',
