...
const reviews = [
  ...
  },
  {
    ...
    text: 'Наше заведение искало способ сделать процесс бронирования столиков удобнее для наших гостей, и решение от Loyalhub оказалось идеальным. Приложение позволяет не только быстро забронировать стол, но и дает возможность просмотреть меню заранее. Это не только улучшило клиентский опыт, но и упростило нашу работу с заказами. Удобный интерфейс, интуитивное управление — все работает без сбоев. Мы довольны сотрудничеством с командой Loyalhub и рекомендуем их услуги другим заведениям!',
  },
];
</script>
